...
const _PROPS = {
  ...
  _DAOJISHISTART:'daojishiStart',
  _DAOJISHISTOP:'daojishiStop',
}
let _cache = []
 ...
 * @param {*} conf 
 */
function createConf(id, remarkName,password,currentTab,daojishiStart,daojishiStop, conf) {
  return {
    [_PROPS._ID]: id,
    [_PROPS._REMARKNAME]: remarkName || '',
    [_PROPS._CONF]: conf || [],
    [_PROPS._PASSWORD]: password || '',
    [_PROPS._CURRENTTAB]: currentTab || '',
    [_PROPS._DAOJISHISTART]: daojishiStart || '',
    [_PROPS._DAOJISHISTOP]: daojishiStop || '',
  }
}
